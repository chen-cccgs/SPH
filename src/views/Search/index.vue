  ...
  <div>
    ...
    <div class="main">
      <div class="py-container">
        ...
        <!--selector-->
        <SearchSelector @TMselect="TMselect" @attrSelect="attrSelect" />
        ...
        <div class="details clearfix">
            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{ active: searchParams.order.split(':')[0] === '1' }">
                  <a @click="handleSort('1')">综合<span v-show="searchParams.order === '1:desc'">⬇</span><span
                      v-show="searchParams.order === '1:asc'">⬆</span></a>
                </li>
                <li :class="{ active: searchParams.order.split(':')[0] === '2' }">
                  <a @click="handleSort('2')">价格<span v-show="searchParams.order === '2:desc'">⬇</span><span
                      v-show="searchParams.order === '2:asc'">⬆</span>
                  </a>
                </li>
                <li>
                  <a>销量</a>
          ...
          <div class="goods-list">
            <ul class="yui3-g">
              <li class="yui3-u-1-5" v-for="goods in searchList.goodsList">
                <div class="list-wrap">
                  <div class="p-img">
          ...
          <Pagination @pageJump='pageJump' :pageNo="searchParams.pageNo" :pageSize="searchParams.pageSize" :total="searchList.total" :continue="2" />            
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    attrSelect(attr, value) {
      const elementToAdd = `${attr.attrId}:${value}:${attr.attrName}`;
      if (!this.searchParams.props.includes(elementToAdd)) {
        this.searchParams.props.push(elementToAdd);
        this.getData();
      }
    },
    removeAttr(index) {
