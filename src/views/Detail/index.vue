<template>
  <div class="detail">
    ...
    <section class="con">
      <!-- 导航路径区域 -->
      <div class="conPoin">
        <span v-if="commodityDetails.categoryView && commodityDetails.categoryView.category1Name">{{ commodityDetails.categoryView.category1Name }}</span>
        <span v-if="commodityDetails.categoryView && commodityDetails.categoryView.category2Name">{{ commodityDetails.categoryView.category2Name }}</span>
        <span v-if="commodityDetails.categoryView && commodityDetails.categoryView.category3Name">{{ commodityDetails.categoryView.category3Name }}</span>
      </div>
      <!-- 主要内容区域 -->
      <div class="mainCon">
        <!-- 左侧放大镜区域 -->
